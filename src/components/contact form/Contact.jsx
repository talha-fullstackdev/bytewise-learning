...
const Contact = () => {
  return (
    <div className='mt-6 md:pt-3' id='contact'>
        <h2 className='text-center md:text-4xl text-xl'>Contact</h2>
        <p className='text-center text-md mt-4 md:mt-2'>Get in touch with Bytewise Learning for collaborations, inquiries, or any questions you may have.</p>
